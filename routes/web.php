...
Route::get('/user/editVerify/{id}', [AuthController::class, 'editVerify'])->name('editVerify')->middleware('auth');
Route::post('/user/postEditVerify/{id}', [AuthController::class, 'postEditVerify'])->name('postEditVerify')->middleware('auth');
