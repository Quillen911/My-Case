...
<body>
    ...
    <div class="form-container">
        ...
        @endif
        @if((session('error') || $errors->any()) && count(request()->old()) > 0)
        ...
        <form action="{{ route('postSettings')}}" method="POST">
            ...
            <div class="floating-label">
                <div class="input-wrapper">
                    <input type="text" name="username" value="{{ old('username', isset($admin) ? $admin->username : '') }}" placeholder=" " required>
                    <label>👤 Kullanıcı Adı</label>
                </div>
            </div>
            <div class="floating-label">
                <div class="input-wrapper">
                    <input type="email" name="email" value="{{ old('email', isset($admin) ? $admin->email : '') }}" placeholder=" " required>
                    <label>📧 Email Adresi</label>
                </div>
            </div>
            <div class="button-group">
                <button type="submit" class="btn-primary">💾 Kaydet</button>
                <a href="{{ route('main') }}" class="btn-secondary">🔙 Geri Dön</a>
            </div>
        </form>
    </div>
</body>
