    ...
    <div class="form-container">
        ...
        <form action="{{ route('add.show') }}" method="POST">
            ...
            <div class="form-group">
                <input type="text" name="categoryTitle" placeholder="📌 Kategori Adı" required value="{{ isset($old['categoryTitle']) ? $old['categoryTitle'] : old('categoryTitle') }}">
                @error('categoryTitle')
            ...
            <div class="form-group">
                <input type="text" name="categoryDesc" placeholder="📝 Kategori Açıklaması" required value="{{ isset($old['categoryDesc']) ? $old['categoryDesc'] : old('categoryDesc') }}">
                @error('categoryDesc')
                    <div class="message error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                <input type="text" name="categoryStatus" placeholder="⚙️ Kategori Durumu" required value="{{ isset($old['categoryStatus']) ? $old['categoryStatus'] : old('categoryStatus') }}">
