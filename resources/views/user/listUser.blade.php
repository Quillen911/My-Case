...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Sistemdeki tüm kullanıcıları görüntüle ve yönet</p>
        </div>
                        ...
                        @foreach($user as $u)
                            <tr>
                                <td class="checkbox-cell">
                                    <input type="checkbox" class="note-checkbox" name="user_ids[]" value="{{$u->id}}" style="display:none;">
                                </td>
                                <td><span class="id-badge">#{{$u->id}}</span></td>
                                <td><strong>{{$u->username}}</strong></td>
                                <td>{{$u->email}}</td>
                                <td>
                                    <a href="{{route('editVerify', $u->id)}}" class="edit-link">✏️ Düzenle</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="nav-section">
            ...
            <a href="{{ route('deleteListUser') }}" class="nav-link btn-secondary">🗑️ Silinenler</a>
        </div>
    </div>
</body>
</html>